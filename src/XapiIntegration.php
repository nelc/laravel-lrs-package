...
use Nelc\LaravelNelcXapiIntegration\Interactions\Attended;
...
class XapiIntegration
{
    ...
    public function Attended($actor, $actorEmail, $lessonUrl, $lessonTitle, $lessonDesc, bool $completion, $duration, $courseId, $courseTitle, $courseDesc, $instructor, $instructorEmail)
    {
        $instance = new Attended();
        $data = $instance->Send($actor, $actorEmail, $lessonUrl, $lessonTitle, $lessonDesc, $completion, $duration, $courseId, $courseTitle, $courseDesc, $instructor, $instructorEmail);
